...
class CashTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => __('backend.case_type_added_successfully'),
    ...
    public function update(Request $request, $id)
    {
        ...
        $casetype->save();
           ...
           return response()->json([
            'success' => true,
            'message' => __('backend.case_type_edited_successfully'),
     ...
     */
       ...
       $data->is_active  = $request->status == 'true' ? 'Yes' : 'No' ;
        ...
        $message = __('backend.case_type_status_changed_successfully') ;
    ...
    public function destroy($id)
    {
        ...
        $row = CaseType::destroy($id);
          ...
          return response()->json([
                       'success' => true ,
                       'message' => __('backend.case_type_deleted_successfully')
                       ],200);
                  ...
                  return response()->json([
                       'error' => true ,
                       'errormessage' => __('backend.cannot_delete_case_type_used')
                       ],400);
        }
    }
