                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <input type="text" placeholder="" class="form-control lp-input" id="email" name="email">
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.client.mobile_no') }} <span
                                        class="text-danger">*</span></label>
                                <input type="text" placeholder="" class="form-control lp-input" id="mobile" maxlength="10"
                                    name="mobile">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.client.country') }} <span
                                        class="text-danger">*</span></label>
                                <select class="form-control lp-input select-change country-select2" name="country" id="country"
                        ...
                        <div class="form-group lp-form-group pull-right">
                            <div class="col-md-12 col-sm-6 col-xs-12">
                                <a href="{{ route('clients.index') }}" class="btn btn-danger lp-btn">
