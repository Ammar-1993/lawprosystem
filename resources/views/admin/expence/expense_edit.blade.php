    ...
    <form class="repeater" id="add_expense" name="add_expense" role="form" method="POST"
        ...
        <div class="page-title">
            <div class="title_left">
                <h3><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;{{__('frontend.edit_expense')}}</h3>
            </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group lp-form-group">
                                    ...
                                    <label for="billed_from">{{__('frontend.billed_from')}} <span class="text-danger">*</span></label><br>
                                        ...
                                        @foreach($expense->expense_iteam as $item)
                                            <tr data-repeater-item>
                                                <th width="" class="text-center">
                                                    ...
                                                    <select class="form-control lp-input sel categories_ids"
                                                ...
                                                <th width="5%" class="text-center">
                                                    ...
                                                    <button type="button" data-repeater-delete type="button"
                                                            class="btn btn-danger lp-btn lp-btn-danger waves-effect waves-light btn_remove">
                                ...
                                <div class="col-sm-7 col-md-7">
                                    <div class="contct-info">
                                        <div class="form-group lp-form-group">
                                            ...
                                            <textarea class="form-control lp-input" id="note" name="note"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="text" value="{{ $expense->tax_amount ?? ''}}" name="taxVal"
                                                       class="form-control lp-input expence-sub-total" id="taxVal" readonly=""
                                                >
                                            </td>
                                        </tr>
                                    </table>
