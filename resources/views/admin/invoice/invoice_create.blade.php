    ...
    <form class="repeater" id="add_invoice" name="add_invoice" role="form" method="POST"
        ...
        <div class="page-title">
            <div class="title_left">
                <h3><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;{{__('frontend.add_invoice')}}</h3>
            </div>
                                ...
                                <table class="table lp-table tableInv" id="purchaseInvoice" data-repeater-list="invoice_items">
                                    ...
                                    <tr data-repeater-item>
                                        ...
                                        <th width="30%" class="text-center">
                                            <select class="form-control lp-input sel services" name="services" id="services"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="text" name="subTotal"
                                                       class="form-control lp-input expence-sub-total" id="subTotal"
                                                       readonly=""
                                                >
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="text" value="" name="taxVal"
                                                       class="form-control lp-input expence-sub-total"
                                                       id="taxVal" readonly=""
                                                >
                                            </td>
                                        </tr>
