                        ...
                        <div class="col-md-12">
                            <div class="right-part-bg-all">
                                <div class="ctzn-usrs">
                                    ...
                                    <h1 class="text-center">{{__('frontend.invoice')}}</h1>
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="invoice-title">
                                                <h3 class="pull-right">{{__('frontend.invoice_no')}}: {{ $invoice_no ?? ''}}</h3>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 text-right">
                                                    <address>
                                                        <strong>{{__('frontend.invoice_date')}}</strong> {{ $inv_date ?? ''}}<br>

                                                        <strong>{{__('frontend.invoice_due_date')}}</strong> {{ $due_date ?? ''}}<br>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-condensed">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left"><strong>{{__('frontend.service')}}</strong></td>
