...
@section('content')
    <div class="">
        ...
        @component('component.modal_heading',
             [
             'page_title' => __('frontend.court_management'),
             'action'=>route("court.create"),
             'model_title'=>__('frontend.add_court'),
             'modal_id'=>'#addtag',
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel lp-panel">
                    ...
                    <div class="x_content">
                        ...
                        <table id="tagDataTable" class="table lp-table" data-url="{{ route('court.list') }}"  width="100%">
                            <thead>
                            <tr>
