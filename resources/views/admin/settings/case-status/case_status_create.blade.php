        ...
        <form action="{{ route('case-status.store') }}" method="POST" id="tagForm" name="tagForm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">{{__('frontend.add_case_status')}}</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group lp-form-group">
                            <label for="case_subtype">{{__('frontend.case_status')}}<span class="text-danger">*</span></label>
                            <input type="text" placeholder="" class="form-control lp-input" id="case_status" name="case_status">
                        </div>
                    </div>
...
<input type="hidden" name="common_check_exist"
       ...
       {{-- الكود الجديد لتمرير رسائل التحقق والنصوص العامة --}}
<script>
    var caseStatusValidationMessages = @json(__('backend.case_status_validation'));
</script>
{{-- نهاية الكود الجديد --}}
