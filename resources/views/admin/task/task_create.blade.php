                ...
                <form id="add_client" name="add_client" role="form" method="POST" autocomplete="nope"
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.task.start_date') }} <span
                                        class="text-danger">*</span></label>
                                <input type="text" placeholder="" class="form-control lp-input dateFrom" id="start_date"
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.task.deadline') }}<span
                                        class="text-danger">*</span></label>
                                <input type="text" placeholder="" class="form-control lp-input dateTo" id="end_date"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group task_selection hide">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <textarea class="form-control lp-input" id="task_description" name="task_description"></textarea>
                            </div>
                        </div>
