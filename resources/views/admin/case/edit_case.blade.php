                                                ...
                                                <div class="contct-info">
                                                    <div class="form-group lp-form-group">
                                                        ...
                                                        <input type="text" id="party_name" name="party_name"
                                                               ...
                                                               class="form-control lp-input" value="{{$party->party_name}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="contct-info">
                                                    <div class="form-group lp-form-group">
                                                        ...
                                                        <input type="text" id="party_advocate" name="party_advocate"
                                                               ...
                                                               class="form-control lp-input" value="{{$party->party_advocate}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <select class="form-control lp-input" id="case_sub_type" name="case_sub_type">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <input type="text" id="registration_number" name="registration_number"
                                       class="form-control lp-input" value="{{$case->registration_number}}">
                            </div>
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <textarea id="description" name="description"
                                          class="form-control lp-input">{{$case->description ?? ''}}</textarea>
                            </div>
                        </div>
        ...
        <div class="row">
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <select class="form-control lp-input" id="court_name"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <textarea id="remarks" name="remarks"
                                          class="form-control lp-input">{{$case->remark ?? ''}}</textarea>
            ...
            <div class="form-group lp-form-group pull-right">
                <div class="col-md-12 col-sm-6 col-xs-12">
                    ...
                    <button type="submit" class="btn btn-success lp-btn lp-btn-primary"><i class="fa fa-save" id="show_loader"></i>&nbsp;{{__('frontend.save')}}
                    </button>
                </div>
