   ...
   <div class="">
       <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-star"></i>&nbsp;&nbsp;{{__('frontend.cases_management')}}</h3>
              </div>
                ...
                <div class="row">
                   ...
                   <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                     ...
                     <button type="submit" id="search" disabled="disabled"  class="btn btn-success lp-btn lp-btn-primary"> <i class="fa fa-search"></i>{{__('frontend.search')}}</button>
                   </div>
