    ...
    <div class="page-title">
        ...
        <div class="title_right">
            <div class="form-group lp-form-group pull-right top_search">
                <a href="{{ route('case-running.index') }}" class="btn btn-primary lp-btn lp-btn-primary">{{ __('frontend.back') }}</a>
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <select class="form-control lp-input" name="client_name" id="client_name">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group lp-form-group">
                                                ...
                                                <input type="text" id="party_name" name="party_name"
                                                    ...
                                                    data-msg-required="{{ __('frontend.enter_name') }}" class="form-control lp-input">
                                            </div>
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <div class="form-group lp-form-group">
                                                ...
                                                <button type="button" data-repeater-delete type="button"
                                                    class="btn btn-danger lp-btn lp-btn-danger waves-effect waves-light"><i class="fa fa-trash-o"
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <input type="text" id="case_no" name="case_no" class="form-control lp-input">
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.case_type') }}<span
                                        class="text-danger">*</span></label>
                                <select class="form-control lp-input" id="case_type" name="case_type"
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.case_sub_type') }}<span
                                        class="text-danger"></span></label>
                                <select class="form-control lp-input" id="case_sub_type" name="case_sub_type"></select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.stage_of_case') }}<span
                                        class="text-danger">*</span></label>
                                <select class="form-control lp-input" id="case_status" name="case_status">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <input type="text" id="act" name="act" class="form-control lp-input">
                            </div>
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.filing_number') }}<span
                                        class="text-danger">*</span></label>
                                <input type="text" id="filing_number" name="filing_number" class="form-control lp-input">
                            </div>
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.filing_date') }}<span
                                        class="text-danger">*</span></label>
                                <input type="text" id="filing_date" name="filing_date"
                                    class="form-control lp-input datetimepickerfilingdate" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                ...
                                <input type="text" id="filiregistration_dateng_date" name="registration_date"
                                    class="form-control lp-input datetimepickerregdate" readonly="">
                            </div>
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.first_hearing_date') }}<span
                                        class="text-danger">*</span></label>
                                <input type="text" id="next_date" name="next_date"
                                    class="form-control lp-input datetimepickernextdate" readonly="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.cnr_number') }}<span
                                        class="text-danger"></span></label>
                                <input type="text" id="cnr_number" name="cnr_number" class="form-control lp-input">
                            </div>
                            <div class="col-md-9 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.description') }}<span
                                        class="text-danger"></span></label>
                                <textarea id="description" name="description" class="form-control lp-input"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.police_station') }}<span
                                        class="text-danger"></span></label>
                                <input type="text" id="police_station" name="police_station" class="form-control lp-input">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.fir_number') }}<span
                                        class="text-danger"></span></label>
                                <input type="text" id="fir_number" name="fir_number" class="form-control lp-input">
                            </div>
        ...
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.court_no') }}<span
                                        class="text-danger">*</span></label>
                                <input type="text" id="court_no" name="court_no" class="form-control lp-input">
                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.court_type') }}<span
                                        class="text-danger">*</span></label>
                                <select class="form-control lp-input" id="court_type" name="court_type"
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.court') }} <span
                                        class="text-danger">*</span></label>
                                <select class="form-control lp-input" id="court_name" name="court_name"></select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.judge_name') }}<span
                                        class="text-danger">*</span></label>
                                <select class="form-control lp-input select2" id="judge_type" name="judge_type">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group lp-form-group">
                                <label for="fullname">{{ __('frontend.remarks') }}<span
                                        class="text-danger"></span></label>
                                <textarea id="remarks" name="remarks" class="form-control lp-input"></textarea>
            ...
            <div class="form-group lp-form-group pull-right">
                <div class="col-md-12 col-sm-6 col-xs-12">
                    ...
                    <a class="btn btn-danger lp-btn lp-btn-danger" href="{{ route('case-running.index') }}">{{ __('frontend.cancel') }}</a>
