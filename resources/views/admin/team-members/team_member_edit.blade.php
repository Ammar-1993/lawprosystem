...
@section('content')
    ...
    <div class="page-title">
        <div class="title_left">
            <h3><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;{{__('frontend.edit_member')}}</h3>
        </div>
                    ...
                    <form id="add_user" name="add_user" role="form" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <span class="fa fa-upload text-center font-15"><span
                                                ...
                                                <button type="button" class="btn btn-default lp-btn" id="cancel_img">{{__('frontend.cancel')}}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-9 lp-form-group">
                                        <label for="address">{{__('frontend.address')}} <span class="text-danger">*</span></label>
                                        <input type="text" id="address" name="address" class="form-control lp-input"
                                               value="{{ $users->address}}">
                                    </div>
                                    <div class="col-md-3 lp-form-group">
                                        <label for="zipcode">{{__('frontend.zip_code')}}<span class="text-danger">*</span></label>
                                        <input type="text" id="zip_code" name="zip_code" class="form-control lp-input"
                            ...
                            <div class="form-group pull-right">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    <br>
                                    <a class="btn btn-danger lp-btn lp-btn-danger" href="{{ url('admin/client_user') }}">{{__('frontend.cancel')}}</a>
                                    <button type="submit" class="btn btn-success lp-btn lp-btn-primary" id="upload-result"><i
